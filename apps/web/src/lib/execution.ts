...
import type { ExecuteRequest, ExecutionResult, SupportedLanguage } from "@interviewhub/types";
 ...
 */
async function callJudge0(input: ExecuteRequest): Promise<Judge0SubmissionResponse> {
  ...
  try {
    ...
    return await prisma.execution.update({
      ...
      data: {
        ...
        // falling back to it here is what stops a failed compile from
        // showing as an empty output panel.
